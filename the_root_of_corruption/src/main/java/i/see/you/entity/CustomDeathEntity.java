...
public class CustomDeathEntity extends Monster {
	public static final EntityDataAccessor<Integer> DATA_run = SynchedEntityData.defineId(CustomDeathEntity.class, EntityDataSerializers.INT);
	public final AnimationState animationState2 = new AnimationState();
	public final AnimationState animationState3 = new AnimationState();

	public CustomDeathEntity(EntityType<CustomDeathEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(5, new LookAtPlayerGoal(this, Player.class, (float) 66));
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("the_root_of_corruption:goaway"));
	}
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("the_root_of_corruption:failed"));
	}
