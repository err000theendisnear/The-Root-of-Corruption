...
public class EntitySpawnerEntity extends Monster {
	public EntitySpawnerEntity(EntityType<EntitySpawnerEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("the_root_of_corruption:jumpscare")), 0.15f, 1);
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata) {
		...
		SpawnrandomentityProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
