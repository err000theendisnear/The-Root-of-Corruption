...
import i.see.you.procedures.FireballProcedure;
import i.see.you.procedures.BombProcedure;

public class InvalidCreeperEntity extends Monster {
	public InvalidCreeperEntity(EntityType<InvalidCreeperEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void thunderHit(ServerLevel serverWorld, LightningBolt lightningBolt) {
		...
		FireballProcedure.execute(this);
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		BombProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
