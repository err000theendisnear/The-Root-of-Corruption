...
import i.see.you.procedures.SpiltProcedure;

public class MinecraftRootEntity extends Monster {
	private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.RED, ServerBossEvent.BossBarOverlay.PROGRESS);

	public MinecraftRootEntity(EntityType<MinecraftRootEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		SpiltProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
