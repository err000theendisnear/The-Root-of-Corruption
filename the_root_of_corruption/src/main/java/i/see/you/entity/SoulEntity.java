...
import i.see.you.procedures.SoulspawnProcedure;
import i.see.you.procedures.ErrsoulProcedure;
import i.see.you.init.TheRootOfCorruptionModEntities;

public class SoulEntity extends Monster {
	public SoulEntity(EntityType<SoulEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		ErrsoulProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}

	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(TheRootOfCorruptionModEntities.SOUL.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
			return SoulspawnProcedure.execute(world, x, y, z);
