...
import i.see.you.procedures.UdfchaseSpawnProcedure;
import i.see.you.procedures.UdfChaseProcedure;
import i.see.you.procedures.KickProcedure;

public class UndefindchaseEntity extends Monster {
	public UndefindchaseEntity(EntityType<UndefindchaseEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
