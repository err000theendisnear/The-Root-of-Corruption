...
import i.see.you.procedures.UdfstaretickupdateProcedure;
import i.see.you.procedures.UdfchaseSpawnProcedure;
import i.see.you.procedures.CavesoundProcedure;

public class UndefindstareEntity extends Monster {
	public UndefindstareEntity(EntityType<UndefindstareEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	public void baseTick() {
		super.baseTick();
		UdfstaretickupdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
