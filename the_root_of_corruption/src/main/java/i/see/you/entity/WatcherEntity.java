...
public class WatcherEntity extends Monster {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new LookAtPlayerGoal(this, ServerPlayer.class, (float) 128));
	...
	public void tick() {
		...
		if (this.level().isClientSide()) {
			this.animationState0.animateWhen(ReturnTrueProcedure.execute(), this.tickCount);
		}
	}
