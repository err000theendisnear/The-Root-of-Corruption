...
public class YourjavaisdieChaseEntity extends Monster {
	...
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("the_root_of_corruption:noise")), 0.15f, 1);
	}
	...
	public void baseTick() {
		super.baseTick();
		JavatickupdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
