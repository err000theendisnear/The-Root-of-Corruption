...
import i.see.you.procedures.NoslownessProcedure;
import i.see.you.procedures.NoWaJuePiLaoProcedure;
import i.see.you.procedures.InfiniteNightVisionProcedure;
import i.see.you.procedures.GlitchWalkerProcedure;
import i.see.you.init.TheRootOfCorruptionModItems;

import com.google.common.collect.Iterables;

@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD)
public abstract class MissingArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			ArmorMaterial armorMaterial = new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
				...
				map.put(ArmorItem.Type.LEGGINGS, 37);
	...
	public MissingArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends MissingArmorItem {
		public Helmet() {
	...
	public static class Chestplate extends MissingArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends MissingArmorItem {
		public Leggings() {
	...
	public static class Boots extends MissingArmorItem {
		public Boots() {
