		...
		if (world instanceof ServerLevel _origLevel) {
			...
			if (world != null) {
				...
				if (!world.isClientSide() && world.getServer() != null)
					world.getServer().getPlayerList().broadcastSystemMessage(Component.literal(("you need to:" + TheRootOfCorruptionModVariables.MapVariables.get(world).blockx + " " + TheRootOfCorruptionModVariables.MapVariables.get(world).blocky
							+ " " + TheRootOfCorruptionModVariables.MapVariables.get(world).blockz)), false);
