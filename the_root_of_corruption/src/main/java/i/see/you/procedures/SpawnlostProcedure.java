...
public class SpawnlostProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		TheRootOfCorruptionMod.queueServerWork(100, () -> {
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = TheRootOfCorruptionModEntities.LOST_MEMORY.get().spawn(_level, BlockPos.containing(x, y, z), MobSpawnType.MOB_SUMMONED);
